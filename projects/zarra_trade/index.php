...
//db connection;
$db_connect = db_connection("local_host");

//Slider images array;
$sliderImages = array(2,3);
...
//          Title name;
            switch($page) {
                case "main":$sPageName = "За нас";
                    break;
                case "news":$sPageName = "Новини";
                    break;
                case "products":$sPageName = "Продукти";
                    break;
...
<!doctype html>
    <head>
        ...
        <!-- Title-->
        <title>Зара Трейд<?php echo "/".$sPageName;?></title>
            ...
            <nav class="navbar navbar-default navbar-fixed-top">
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <a href="#" class="navbar-brand">Зара Трейд</a>
                    ...
                    <div class="collapse navbar-collapse" id="myNavbar">
                        <ul class="nav navbar-nav navbar-right" >
                            <li><a id="main" href="?page=main">За Нас</a></li>
                            <li><a id="news" href="?page=news">Новини</a></li>
                            <li><a id="products" href="?page=products">Продукти</a></li>
